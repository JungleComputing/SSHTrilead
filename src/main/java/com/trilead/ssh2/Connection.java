...
public class Connection
{
	...
	/**
	 * Attempts to authenticate the connection using an ssh-agent.
	 * 
	 * @param user the user name.
	 * @return whether the connection is now authenticated.
	 */
	public synchronized boolean authenticateWithPublicKey(String user) throws IOException {
		if (tm == null)
			throw new IllegalStateException("Connection is not established!");
		...
		authenticated = am.authenticatePublicKey(user); 
		return authenticated;
	}
	...
	public synchronized void enableDebugging(boolean enable, DebugLogger logger)
	{
		Logger.enabled = enable;
                ...
                System.err.println("Enabling debugging: " + enable);
			...
			if (logger == null)
			{
				logger = new DebugLogger()
				{
					...
					public void log(int level, String className, String message)
					{
                        ...
                        System.err.println("Enabling debugging");
