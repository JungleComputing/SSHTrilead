...
public class Packets
{
	...
	// Communication with ssh agent added --Ceriel
	...
	static
	{
		...
		// Added reverse names for ssh agent communication
		reverseNames[SSH2_AGENTC_REQUEST_IDENTITIES] = "SSH2_AGENTC_REQUEST_IDENTITIES";
		reverseNames[SSH2_AGENTC_SIGN_REQUEST] = "SSH2_AGENTC_SIGN_REQUEST";
		reverseNames[SSH2_AGENT_IDENTITIES_ANSWER] = "SSH2_AGENT_IDENTITIES_ANSWER";
		reverseNames[SSH2_AGENT_SIGN_RESPONSE] = "SSH2_AGENT_SIGN_RESPONSE";
